...
export const FeaturesSection: React.FC = () => {
  return (
    <section
      className="px-6 py-20 mx-auto my-0 max-w-screen-xl bg-neutral-900"
      aria-labelledby="features-title"
    >
      <h2 id="features-title" className="mb-16 text-5xl text-center">
        Simplify. Empower. Achieve.
      </h2>
      <div className="grid gap-8 mb-16 grid-cols-[repeat(auto-fit,minmax(300px,1fr))]">
        <article className="p-8 bg-gray-900 rounded-lg border border-solid border-neutral-700">
